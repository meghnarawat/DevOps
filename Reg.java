...
public class fbregistration {
  ...
  public void f() {
    ...
    driver.findElement(By.id("u_0_5")).sendKeys("writemeghnarawat.com");
   
    driver.findElement(By.id("u_0_8")).sendKeys("writemeghnarawat.com");
    driver.findElement(By.id("u_0_a")).sendKeys("xyz12345");
    new org.openqa.selenium.support.ui.Select(driver.findElement(By.xpath("//*[@name='birthday_day']"))).selectByVisibleText("");
